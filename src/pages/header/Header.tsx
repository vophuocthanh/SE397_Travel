  ...
  return (
    <div className={className}>
      ...
      <svg
        ...
        className={` top-8 right-4 lg:hidden inline-flex items-center justify-center w-10 h-10 p-2 rounded-lg bg-white hover:bg-white focus:outline-none focus:ring-2 focus:ring-gray-200 dark:bg-gray-900 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-600 transition-colors duration-300 focus:ring-gray-200 dark:bg-gray-900 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-600 transition-colors duration-300 ${menuStyle}`}
