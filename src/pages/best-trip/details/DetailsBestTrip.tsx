...
export default function DetailsBestTrip() {
  ...
  const giaFormatted = new Intl.NumberFormat('en-US', {
    style: 'currency',
    currency: 'USD',
  }).format(detailsBestTrip?.data?.data?.data?.price);
  return (
    <div>
      ...
      <div className='flex m-[45px] max-sm:mb-[8rem] max-lg:space-around  '>
        {detailsBestTrip ? (
          ...
          <p className='mb-4 text-4xl font-bold text-slate-600'>
            {detailsBestTrip?.data?.data?.data?.name}
          </p>
            ...
            <div className='flex '>
              <div className='w-[40rem] mr-8 '>
                <div className='h-24 mb-20 overflow-hidden overflow-y-auto'>
                  <p className='mb-6'>
                    {detailsBestTrip?.data?.data?.data?.description}
                  </p>
                </div>
                <div className='p-4 rounded-md shadow-md bg-slate-200'>
                  ...
                  {t("time")}:{' '}
                    <span className='text-base font-bold'>
                      {detailsBestTrip?.data?.data?.data?.time_out}
                    </span>
                  </p>
                  <p className=''>
                    {' '}
                    {t("Starting")}:{' '}
                    <span className='text-base font-bold'>
                      {detailsBestTrip?.data?.data?.data?.starting_gate}
                    </span>
                  </p>
                  <p>
                  {t("Number of seats available")}:{' '}
                    <span className='text-base font-bold'>
                      {detailsBestTrip?.data?.data?.data?.remainingCount}
                    </span>
                  </p>
                  <p>
                  {t("buy")}:{' '}
                ...
                <div className='w-[50rem]'>
                  <div className='flex justify-between '>
                    ...
                    <div className='w-40'>
                      ...
                      <p className='mt-3'>
                        {detailsBestTrip?.data?.data?.data?.transport}
                      </p>
                    </div>
                    <div className='w-40'>
                      <img
                      ...
                      <p className='mt-3'>
                        {detailsBestTrip?.data?.data?.data?.sight_seeing}
                      </p>
                    </div>
                    <div className='w-40'>
                      <img
                      ...
                      <p className='mt-3'>
                        {detailsBestTrip?.data?.data?.data?.cuisine}
                      </p>
                    </div>
                  </div>
                  <div className='flex justify-between mt-5'>
                    <div className='w-40'>
                      ...
                      {t("Hotel")} </label>
                      <p className='mt-3'>
                        {detailsBestTrip?.data?.data?.data?.hotel}
                      </p>
                    </div>
                    <div className='w-40'>
                      <img
                      ...
                      {t("Ideal time")}</label>
                      <p className='mt-3'>
                        {detailsBestTrip?.data?.data?.data?.ideal_time}
                      </p>
                    </div>
                    <div className='w-40'>
                      <img
                      ...
                      <p className='mt-3'>
                        {detailsBestTrip?.data?.data?.data?.suitable_subject}
                      </p>
                    </div>
                    <div className='w-40'>
                      <img
                      ...
                      {t("Endow")}</label>
                      <p className='mt-3'>
                        {detailsBestTrip?.data?.data?.data?.vchouer}
                      </p>
                    </div>
                  </div>
                </div>
