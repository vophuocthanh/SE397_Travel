import { LocationCommentType } from '../LocationComment';

const TourCommentContent = ({
  commentData,
}: {
  commentData: LocationCommentType;
}) => {
  ...
  return (
    <div
      className='p-2 mx-5 mt-4 bg-gray-100 border border-gray-300 rounded-lg shadow-md'
      key={commentData.id}
    >
