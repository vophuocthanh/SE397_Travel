    ...
    <div>
      ...
      <div className="flex flex-col flex-wrap w-full mx-auto my-10 gap-14 max-w-7xl">
        ...
        <div className="flex gap-16">
          <Table className="border-2 w-[60rem]">
            <TableHeader>
              <TableRow>
                <TableHead className="w-[220px] text-xl font-bold border px-4 py-2">
                  Ảnh
                </TableHead>
                <TableHead className="w-[120px] text-xl font-bold border px-4 py-2">
                  Tên Tour
                </TableHead>
                <TableHead className="w-[100px] text-xl font-bold border px-4 py-2">
                  Số Lượng
                </TableHead>
                <TableHead className="w-[100px] text-xl font-bold border px-4 py-2">
                  Tổng Tiền
            ...
            <TableBody>
              {CartProducts.map((product) => (
                <TableRow key={product.id}>
                  <TableCell className="flex justify-center px-4 py-2 border-r">
                    <img
                      src={product.image}
                      alt="best trip"
                      className="object-cover h-40 border rounded-md w-[18rem]"
                    />
                  </TableCell>
                  <TableCell className="w-[100px] border px-4 py-2">
                    <h1 className="flex pt-2 pl-1 text-lg">
                      {product.name || product.location}
                    </h1>
                  </TableCell>
                  <TableCell className="w-[100px] border px-4 py-2">
                    <span className="text-xl">{`x${product.quantity}`}</span>
                  </TableCell>
                  <TableCell>
                    <div className="flex items-center justify-center px-4 py-2 border-r">
                      <span className="flex items-center justify-center text-lg">
                        {giaFormatted}
                      </span>
                      <X
                        className="ml-2 text-white bg-red-500 rounded-lg cursor-pointer"
          ...
          <div className="flex flex-col max-w-[24rem] p-4 mt-0 h-80 space-y-4 bg-gray-100 rounded-md">
