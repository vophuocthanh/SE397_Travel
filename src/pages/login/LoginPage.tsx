      ...
      <div className='flex items-center justify-center w-full h-screen mx-auto sm:w-2/3 '>
        <div className='flex flex-col items-center justify-center mx-auto space-y-4 sm:w-2/3 lg:w-1/2'>
          ...
          >
            ...
            {show ? (
              <IconEyShow
                className='absolute -translate-y-1/2 cursor-pointer right-14 md:right-52 top-[49.5%]'
                onClick={() => setShow(false)}
              />
            ) : (
              <IconEyeHidden
                className='absolute -translate-y-1/2 cursor-pointer right-14 md:right-52 top-[48.5%]'
