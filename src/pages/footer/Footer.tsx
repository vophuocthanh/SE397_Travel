...
const Footer = () => {
  return (
      ...
      <div className='mx-auto mb-20 max-w-7xl'>
        <div className="lg:flex text-left justify-normal lg:gap-x-[8rem] ">
          <div className="lg:ml-[7rem] w-65 lg:block ml-[2rem]">
            <h1 className="mb-4 text-2xl font-bold text-black">Du lịch trong nước</h1>
          ...
          <div className="lg:mr-[7rem] w-45 lg:w-60 mr-[1rem]">
            <h1 className="mb-4 text-xl font-semibold text-black">Du lịch nước ngoài</h1>
            <ul className='grid grid-cols-2 gap-4 pt-2'>
              <li>Trung Quốc</li>
              <li>Ấn Độ</li>
              <li>Thái Lan</li>
          ...
          <div>
            <h1 className="mb-4 text-xl font-semibold text-black">Dòng tour</h1>
            ...
            <h1 className="mt-2 mb-4 text-xl font-semibold text-black">Dịch vụ lẻ</h1>
        ...
        <div className='lg:ml-[7rem] lg:w-60 lg:block w-full  '>
            <h1 className="mb-4 text-xl font-semibold text-black">Liên hệ</h1>
            <ul className='grid gap-4 pt-2'>
              <li>(+84) 0386725641</li>
              <li>(+84) 0399931256</li>
              <li>cskhtour2024@gmail.com</li>
            </ul>
            <h1 className="mt-5 mb-4 text-xl font-semibold text-black">Mạng xã hội</h1>
        ...
        <div className='mt-5 lg:ml-auto lg:mt-0'>
            <h1 className="mb-4 text-xl font-semibold text-black">Thông tin</h1>
            <ul className='grid gap-4 pt-2'>
        ...
        <h1 className="mb-4 text-xl font-semibold text-black">Email</h1>
          ...
          <div className='ml-[1rem] lg:ml-0'>
            <h1 className="mb-4 text-xl font-semibold text-black">Chứng Nhận</h1>
            <img src={cn1} className='mb-5 mt-7 '/>
             <img src={cn2} className='mb-3 '/>
          </div>
          <div>
            <h1 className="mb-4 text-xl font-semibold text-black">Chấp nhận thanh toán</h1>
    ...
    <SectionInViewUp className='flex w-full space-y-2 bg-blue-500 gap-x-[2rem] mx-0 justify-center items-center flex-col lg:block lg:flex-row'>
      ...
      <p className=' text-white lg:ml-[10rem]'>Bản quyền của TravelTour © 2024</p>
    </SectionInViewUp>
    </div>);
};
